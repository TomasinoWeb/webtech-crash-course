...
const badgeStyles = cva(
  'flex size-fit items-center justify-center gap-2 rounded-md border px-1.5 py-1 text-xs font-semibold md:px-2 md:py-1.5',
  {
    variants: {
      color: {
        yellow:
        ...
        grey: 'border-gray-300 bg-gray-100 text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100',
        blue: 'border-blue-300 bg-blue-100 text-blue-900 dark:border-blue-700 dark:bg-blue-800 dark:text-blue-100',
        green:
          'border-green-300 bg-green-100 text-green-900 dark:border-green-700 dark:bg-green-800 dark:text-green-100',
      },
    },
    defaultVariants: {
      color: 'yellow',
